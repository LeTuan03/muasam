...
import { getOrderByProfile } from './ProgressServices';
...
function Progress() {
    ...
    return (
        <>
                            ...
                            <div className="mb-8 main-box border border-gray-200 rounded-xl pt-3 max-w-xl max-lg:mx-auto lg:max-w-full">
                                ...
                                <div className="w-full border-t border-gray-200 px-6 flex flex-col lg:flex-row items-center justify-between ">
                                    <div className="flex flex-col sm:flex-row items-center max-lg:border-b border-gray-200">
                                        <button onClick={handleOpen} type="button" className="text-white bg-[#f7472e] hover:bg-[#f7472e]/80 focus:ring-4 focus:outline-none focus:ring-[#f7472e]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:hover:bg-[#f7472e]/80 dark:focus:ring-[#f7472e]/40 me-2 mb-2">
            ...
            {open && <DialogConfirm open={open} handleClose={handleClose} dataState={dataState} />
            }
