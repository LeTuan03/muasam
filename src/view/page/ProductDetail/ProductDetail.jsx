...
const ProductDetail = () => {
    ...
    const getProductDetail = async () => {
        try {
            ...
            const data2 = await getProductDetailByID(id);
    ...
    const handleSelect = (value, name) => {
        if (name === "idSize") {
            let list = listData?.map(i => {
                if (i?.size?.idSize === value) {
                    i.size.isSelect = true;
                } else {
                    i.size.isSelect = false;
                }
                return i;
            });
            setlistData(list)
        ...
        if (name === "idColor") {
            let list = listData?.map(i => {
                if (i?.color?.idColor === value) {
                    i.color.isSelect = true;
                } else {
                    i.color.isSelect = false;
                }
                return i;
            });
            setlistData(list);
        ...
        <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 ">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <Link to="#" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 ">Sản phẩm</Link>
                        </div>
                    </li>
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">{item?.productName}</span>
                        </div>
                    </li>
                </ol>
            </nav>
            <div className="flex justify-center items-center lg:flex-row flex-col gap-8">
                <div className="  w-full sm:w-96 md:w-8/12 lg:w-6/12 items-center">
                    <h2 className="font-semibold lg:text-4xl text-3xl lg:leading-9 leading-7 text-gray-800 mt-4">{item?.productName}</h2>
                    ...
                    <div className="lg:mt-11 mt-10">
                        <div className="flex flex-row justify-between">
                            <p className=" font-medium text-base leading-4 text-gray-600">Số lượng</p>
                            <div className="flex">
                                ...
                                <input id="counter" aria-label="input" className="border border-gray-300 h-full text-center w-14 pb-1" type="number" value={count} onChange={(e) => setCount(e.target.value)} />
                    ...
                    <button onClick={handleAddCart} className="focus:outline-none focus:ring-2 hover:bg-black focus:ring-offset-2 focus:ring-gray-800 font-medium text-base leading-4 text-white bg-gray-800 w-full py-5 lg:mt-12 mt-6">Thêm vào giỏ hàng</button>
                </div>
                ...
                <div className=" w-full sm:w-96 md:w-8/12  lg:w-6/12 flex lg:flex-row flex-col lg:gap-8 sm:gap-6 gap-4">
                    ...
                    <div className=" w-full lg:w-4/12 grid lg:grid-cols-1 sm:grid-cols-4 grid-cols-2 gap-6">
                        {dataState?.listImage?.map(i => {
                            return (
                                <div className="bg-gray-100 flex justify-center items-center py-4">
                                    <img src={i?.image || "https://i.ibb.co/0jX1zmR/sam-moqadam-kvmds-Tr-GOBM-unsplash-removebg-preview-1-1.png"} alt="Wooden chair - preview 1" />
                                </div>
                            )
                        })}
                    </div>
            ...
            <section class="bg-white py-12 text-gray-700 sm:py-16 lg:py-20">
                <div class="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
                    <div class="mx-auto max-w-md text-center">
                        <h2 class="font-serif text-2xl font-bold sm:text-3xl">Có thể bạn sẽ thích</h2>
                    </div>

                    <div class="mt-10 grid grid-cols-2 gap-6 lg:mt-16 lg:grid-cols-4 lg:gap-4">
                        <article class="relative">
                            <div class="aspect-square overflow-hidden">
                                <img class="group-hover:scale-125 h-full w-full object-cover transition-all duration-300" src="https://componentland.com/images/oZ_djoBAmHk4vgKQh41YT.png" alt="" />
                            </div>
            ...
            <div className="flex  justify-center items-center w-full">
                <div className="w-full sm:w-96 md:w-8/12 lg:w-full grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 lg:gap-28 sm:gap-x-6 sm:gap-y-12 gap-y-12 sm:mt-14 mt-10">
                    <div>
                        ...
                        <p className="font-semibold text-xl leading-5 text-gray-800 lg:mt-10 mt-9">Độ tin cậy</p>
                        <p className="text-normal text-base leading-6 text-gray-600 mt-4">Mức độ tin cậy sẽ phản ánh cách mà chất lượng của sản phẩm được duy trì từ giai đoạn đầu và kéo dài qua một vài năm sử dụng. </p>
                    </div>
                    <div>
                        <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                        ...
                        <p className="font-semibold text-xl leading-5 text-gray-800 lg:mt-10 mt-9">Sự an toàn</p>
                        <p className="text-normal text-base leading-6 text-gray-600 mt-4">Trong quá trình sản xuất, các Doanh nghiệp sẽ tính cách sử dụng hàng hóa theo cách thông thường và duy trì mức độ bảo vệ cao để đảm bảo an toàn cho người tiêu dùng. </p>
                    </div>
                    <div>
                        <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p className="font-semibold text-xl leading-5 text-gray-800 lg:mt-10 mt-9">Độ bền và tính thẩm mỹ</p>
                        <p className="text-normal text-base leading-6 text-gray-600 mt-4"> Độ bền của một sản phẩm có thể được hiểu là thời lượng sử dụng và tuổi thọ của sản phẩm trong một khoảng thời gian được xác định.</p>
                    </div>
                    <div>
                        <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p className="font-semibold text-xl leading-5 text-gray-800 lg:mt-10 mt-9">Đặc tính sản phẩm</p>
