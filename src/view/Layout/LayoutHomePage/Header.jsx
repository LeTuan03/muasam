    ...
    return (
        ...
        >
            <div className='flex items-center justify-between gap-3'>
                <div><Link to="/"><img src='https://pos.nvncdn.com/be3159-662/store/20230719_2Vl6LJgp.png' className='h-10 pl-2 pr-10' /></Link></div >
                {listCategory?.map(i => {
                    return <div><Link to={`/${i?.idCategories}`}>{i?.cateName}</Link></div>
                })}
            </div >
